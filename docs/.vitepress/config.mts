...
export default defineConfig({
  sitemap: {
    hostname: 'https://web-interview.huaqinda.com',
  },
  head: [
    [
      "meta",
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { link: "/JavaScript/== _===", text: "== 和 ===区别，分别在什么情况使用" },
      ...
      },
      {
        ...
        items: [
          ...
          { link: "/React/Real DOM_Virtual DOM", text: "说说Real DOM和Virtual DOM的区别？优缺点？" },
          { link: "/React/life cycle", text: "说说React生命周期有哪些不同阶段？每个阶段对应的方法是？" },
          { link: "/React/state_props", text: "state和props有什么区别？" },
          { link: "/React/super()_super(props)", text: "super()和super(props)有什么区别？" },
          { link: "/React/setState", text: "说说React中的setState执行机制" },
          ...
          { link: "/React/React refs", text: "说说对React refs的理解？应用场景？" },
          ...
          { link: "/React/Improve performance", text: "说说React性能优化的手段有哪些？" },
    ...
    socialLinks: [
      { icon: 'github', link: '/https://github.com/Alndaly/web-interview' }
    ]
  }
})
